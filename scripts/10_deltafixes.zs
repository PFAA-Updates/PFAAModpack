...
recipes.addShaped(<lwstfc:item.LeatherWaterSac>,
  [[null, <lwstfc:item.WaterSacLeather>, null], 
  [<ore:materialString>, <lwstfc:item.Bladder:*>, <ore:materialString>],
  [null, <lwstfc:item.WaterSacLeather>, <ore:itemKnife>.transformDamage()]]);
  
recipes.addShaped(<lwstfc:item.LeatherWaterSac>,
  [[null, <ore:materialString>, null], 
  [<lwstfc:item.WaterSacLeather>, <lwstfc:item.Bladder:*>, <lwstfc:item.WaterSacLeather>],
  [null, <ore:materialString>, <ore:itemKnife>.transformDamage()]]);
