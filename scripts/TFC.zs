...
recipes.addShaped(<tfcengineer:tile.InductionForge>,
   [[<ore:plateDoubleBlueSteel>, <terrafirmacraft:FireBrick>, <ore:plateDoubleBlueSteel>],
...
// Vanilla chest in creosote barrel
mods.Terrafirmacraft.Barrel.addItemConversion(<minecraft:chest>, <terrafirmacraft:Chest TFC>, <liquid:creosote> * 1500, 0, true, 24, true);
